...
def compute(u0=None):
    ...
    AL = [
        ...
        dict(id="excen", c=True, b=0,
             m="Attache d'un seul côté de l'âme porteuse : la flexion locale hors plan de l'âme sous le moment VEd·z n'est pas couverte par le modèle (rotule à la face d'appui, cordons dimensionnés en conséquence). À examiner pour une âme mince ou un z inhabituel.",
             f=[], d=["z"], e=[], w="Modèle : " + MSB3 + " — z = " + F(R.z_p, 1) + " mm ; tw porteuse = " + F(R.tw_P, 1) + " mm ; tp = " + f0(R.t_p) + " mm."),
