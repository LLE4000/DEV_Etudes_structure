...
ap.run(); ap.run()
t = md(ap)
# valeurs recalées le 01/09/2026 : « Jeu premier lit » passe à 0 par
# défaut (retour bureau) -> e_cdg 5,0 au lieu de 6,0 (3+1+1+jeu)
chk("Poutre : hu,min = 67,2 cm", "**67,2 cm**" in t)
chk("Poutre : hmin = 72,2 cm", "**72,2 cm**" in t)
chk("Poutre : As,req inf = 1905 mm²", "Aₛ,req = 1905 mm²" in t)
chk("Poutre : As,req sup = 1333 mm²", "Aₛ,req = 1333 mm²" in t)
